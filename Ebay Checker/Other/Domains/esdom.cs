...
namespace Ebay_Checker
{
    class esdom
    {
        ...
        {
            Export.Initialize();
            Console.Title = "Mailos | .es extractor";
        fuck:
            Console.Clear();
            ASCII.ASCIII();
            ...
            try
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    for (; ; )
                    {
                        ...
                        Variables.cpm_aux = 0;
                        Colorful.Console.Title = "[Mailos - .es extractor] | Valid: " + Variables.hit + " | Other: " + Variables.other + "| Checked: " + Variables.check + "/" + Variables.combototal + " | CPM: " + Variables.cpm * 60;
                        Thread.Sleep(1000);
                    }
                });
                    ...
                    try
                    {
                        ...
                        using (HttpRequest httpRequest = new HttpRequest())
                        {
                            ...
                            try
                            {
                                ...
                                if (s[0].Contains(".es") || s[0].Contains(".ES"))
                                {
                                    Variables.hit++;
                                    Variables.cpm_aux++;
                                    Variables.check++;
