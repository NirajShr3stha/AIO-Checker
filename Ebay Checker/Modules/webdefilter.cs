...
namespace Ebay_Checker
{
    class webde
    {
        ...
        public static void filter()
        {
            Prsc.yahoo();
            Export.Initialize();
            Console.Title = "Mailos | web.de Filter";
        fuck:
            Console.Clear();
            ASCII.ASCIII();
            ...
            try
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    for (; ; )
                    {
                        ...
                        Variables.cpm_aux = 0;
                        Colorful.Console.Title = "[Mailos - web.de Filter] | Hits: " + Variables.hit + " | Bads: " + Variables.bad + " | Error: " + Variables.error + " | Checked: " + Variables.check + "/" + Variables.combototal + " | CPM: " + Variables.cpm * 60;
                        Thread.Sleep(1000);
                    }
                });
                    ...
                    try
                    {
                        ...
                        using (HttpRequest httpRequest = new HttpRequest())
                        {
                            ...
                            try
                            {
                                ...
                                if (s[0].Contains("@web.de") || s[0].Contains("@WEB.DE"))
                                {
                                    Variables.hit++;
                                    Variables.cpm_aux++;
                                    Variables.check++;
                                    Export.AsResult("/@web.de", s[0] + ":" + s[1]);
                                }
