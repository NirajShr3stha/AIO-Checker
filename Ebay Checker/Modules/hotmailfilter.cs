...
namespace Ebay_Checker
{
    class hotmailect
    {
        ...
        public static void filter()
        {
            Prsc.hotmail();
            Export.Initialize();
            Console.Title = "Mailos | Hotmail, Outlook & Live Filter";
        fuck:
            Console.Clear();
            ASCII.ASCIII();
            ...
            try
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    for (; ; )
                    {
                        ...
                        Variables.cpm_aux = 0;
                        Colorful.Console.Title = "[Mailos - Hotmail, Outlook & Live Filter] | Hits: " + Variables.hit + " | Bads: " + Variables.bad + " | Error: " + Variables.error + " | Checked: " + Variables.check + "/" + Variables.combototal + " | CPM: " + Variables.cpm * 60;
                        Thread.Sleep(1000);
                    }
                });
                    ...
                    try
                    {
                        ...
                        using (HttpRequest httpRequest = new HttpRequest())
                        {
                            ...
                            try
                            {
                                ...
                                if (s[0].Contains("@hotmail") || s[0].Contains("@HOTMAIL"))
                                {
                                    Variables.hit++;
                                    Variables.cpm_aux++;
                                    Variables.check++;
                                ...
                                if (s[0].Contains("@outlook") || s[0].Contains("@OUTLOOK"))
                                {
                                    Variables.hit++;
                                    Variables.cpm_aux++;
                                    Variables.check++;
                                ...
                                if (s[0].Contains("@live") || s[0].Contains("@LIVE"))
                                {
                                    Variables.hit++;
                                    Variables.cpm_aux++;
                                    Variables.check++;
