...
namespace Ebay_Checker
{
    ...
    {
        [STAThread]
        public static void mcstart()
        {
            Prsc.minecraft();
            Export.Initialize();
            Console.Title = "Mailos | MinecraftVM";
        fuck:
            Console.Clear();
            ASCII.ASCIII();
            ...
            try
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    for (; ; )
                    {
                        ...
                        Variables.cpm_aux = 0;
                        Colorful.Console.Title = "[Mailos - MinecraftVM] | Valid: " + Variables.hit + " | Error: " + Variables.error + " | Checked: " + Variables.check + "/" + Variables.combototal + " | CPM: " + Variables.cpm * 60;
                        Thread.Sleep(1000);
                    }
                });
