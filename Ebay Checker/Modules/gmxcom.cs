...
namespace Ebay_Checker
{
    class gmxcom
    {
        ...
        public static void filter()
        {
            Prsc.gmxcom();
            Export.Initialize();
            Console.Title = "Mailos | gmx.com Filter";
        fuck:
            Console.Clear();
            ASCII.ASCIII();
            ...
            try
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    for (; ; )
                    {
                        ...
                        Variables.cpm_aux = 0;
                        Colorful.Console.Title = "[Mailos - gmx.com Filter] | Hits: " + Variables.hit + " | Bads: " + Variables.bad + " | Error: " + Variables.error + " | Checked: " + Variables.check + "/" + Variables.combototal + " | CPM: " + Variables.cpm * 60;
                        Thread.Sleep(1000);
                    }
                });
                    ...
                    try
                    {
                        ...
                        using (HttpRequest httpRequest = new HttpRequest())
                        {
                            ...
                            try
                            {
                                ...
                                if (s[0].Contains("@gmx.com") || s[0].Contains("@GMX.COM"))
                                {
                                    Variables.hit++;
                                    Variables.cpm_aux++;
                                    Variables.check++;
                                    Export.AsResult("/@gmx.com", s[0] + ":" + s[1]);
                                }
